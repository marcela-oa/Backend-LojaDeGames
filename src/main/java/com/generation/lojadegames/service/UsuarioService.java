...
public class UsuarioService {
	...
	public Optional<Usuario> cadastrarUsuario(Usuario usuario) {
		Period idade = Period.between(usuario.getDataNasc(), LocalDate.now());
		...
		if (usuarioRepository.findByUsuario(usuario.getFoto()).isEmpty())
			usuario.setFoto("https://i.imgur.com/Ll3Fof3.jpg");
